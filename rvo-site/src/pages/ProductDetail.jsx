...
const ProductDetail = () => {
  ...
  const images = [
    `https://images.unsplash.com/photo-1544816155-12df9643f36${id ? id.slice(-1) : 0}?auto=format&fit=crop&w=800&q=80`,
    ...
    <div className="section-padding py-24 pt-32 bg-ivory-white min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-16 mb-20">
        ...
        <div className="w-full lg:w-1/2 flex flex-col py-4">
          <div className="mb-2 uppercase text-sm font-bold tracking-widest text-premium-gold">Designer Collection</div>
          <h1 className="text-4xl md:text-5xl font-serif text-forest-green mb-4">Premium Eco Tote Bag</h1>
          
          <div className="text-3xl font-sans font-medium text-forest-green mb-6">₹1,499</div>
          ...
          <div className="bg-forest-green/5 p-4 rounded-lg flex items-center space-x-4 mb-8 border border-forest-green/10">
            ...
            <div>
              ...
              <div className="text-forest-green/80">This product saved 2.1kg textile waste and 14 liters of water.</div>
            </div>
          </div>

          <div className="mb-8">
            <div className="font-semibold text-forest-green mb-2">Material:</div>
            <div className="text-forest-green/80">Recycled thick canvas cotton & upcycled denim lining.</div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8 border-t border-forest-green/10 pt-8">
            ...
            <button className="flex-grow flex items-center justify-center space-x-2 bg-white border border-forest-green text-forest-green px-8 py-3 rounded-full hover:bg-forest-green/5 hover:-translate-y-1 transition-all">
              <FiShoppingBag /> <span>Add to Cart</span>
            </button>
            
            <button className="px-6 py-3 border border-forest-green/20 rounded-full text-forest-green bg-white hover:text-white hover:bg-premium-gold hover:border-premium-gold transition-all">
              <FiHeart className="text-xl" />
            </button>
          </div>

          <button className="w-full premium-btn text-lg py-4 mb-10">
            Buy Now
          </button>
