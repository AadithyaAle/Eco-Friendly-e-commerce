...
const Footer = () => {
  return (
    <footer className="bg-forest-green text-ivory-white py-16 border-t-4 border-premium-gold">
      <div className="section-padding grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left">
        {/* Brand */}
        <div>
          <h2 className="text-3xl font-accent mb-4 text-premium-gold">RVO</h2>
          <p className="text-ivory-white/80 max-w-sm font-sans">
      ...
      <div className="text-center text-sm text-ivory-white/60 mt-12 pt-8 border-t border-white/10">
